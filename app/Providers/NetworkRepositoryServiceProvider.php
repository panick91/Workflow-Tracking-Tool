...
use WTT\Repositories\Eloquent\NetworkRepository;
...
class NetworkRepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('Repositories\Contracts\NetworkRepositoryInterface', function($app)
        {
            return new NetworkRepository(new Network());
        });
    }
}
